...
<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?>>
	...
	<div class="entry-content clearfix">
        ...
        <?php endif; ?>
        <span class="byline"><?php largo_byline(true,true,false,true); ?><span class="small_comments">&nbsp;&nbsp;&nbsp;&nbsp;<?php largo_child_comments();?></span><?php edit_post_link( __('Edit This Post', 'largo'), ' <div class="edit-link">', '</div>'); ?></span>
	</div><!-- .entry-content -->
