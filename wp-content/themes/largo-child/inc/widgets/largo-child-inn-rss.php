...
class largo_child_INN_RSS_widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct( 'largo_child_INN_RSS', __('INN Member Stories', 'largo'), $widget_ops );
	}
	...
	function widget($args, $instance) {
		...
		largo_child_widget_rss_output( $rss, $instance ); ?>
...
function largo_child_widget_rss_output( $rss, $args = array() ) {
