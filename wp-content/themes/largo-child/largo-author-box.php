<div class="author-box author vcard clearfix">
	...
	<?php } else {
		printf( __('<h5>About <span class="fn n">%1$s</span><span class="author-posts-link"><a class="url" href="%2$s" rel="author" title="See all posts by %3$s">More from this author</a></span></h5>', 'largo'),
