<?php
/**
 * The template for displaying argolinks content from the Link Roundups plugin
 *
 * @package WordPress
 */
?>
...
<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?>>
	...
	<header>
		<h5 class="top-tag what-were-reading">What We're Reading</h5>
		<h3 class="entry-title"><a href="<?php echo $argo_link[0]; ?>" rel="bookmark"><?php the_title(); ?></a></h3>
	</header><!-- / entry header -->
