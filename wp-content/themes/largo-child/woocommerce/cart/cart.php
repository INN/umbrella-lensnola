	...
	<tbody>
		...
		<tr>
			<td colspan="6" class="actions">
				...
				<input type="submit" class="button" name="update_cart" value="<?php _e( 'Update', 'woocommerce' ); ?>" /> <input type="submit" class="checkout-button button alt" name="proceed" value="<?php _e( 'Proceed to Checkout &rarr;', 'woocommerce' ); ?>" />
