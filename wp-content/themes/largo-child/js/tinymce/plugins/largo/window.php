...
<head>
	...
	<script language="javascript" type="text/javascript" src="<?php echo get_stylesheet_directory_uri(); ?>/js/tinymce/plugins/largo/tinymce.js"></script>	<style type="text/css">
	li {
		list-style: none;
	}
	ul {
